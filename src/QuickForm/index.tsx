...
const QuickForm: QuickFormComponent = (props, ref) => {
          ...
          {name ? (
            (() => {
              ...
              if (type === 'select' || type === 'Select') {
                ...
                if (type === 'inputsearch' || type === 'InputSearch') {
                  const suffix = (
                    <AudioOutlined
                      style={{
                        fontSize: 16,
  ...
  if (type === 'CardPro') {
    return (
      <CardPro title={header}>
        <div className="dumip-FormBox">{FormDom}</div>
      </CardPro>
    );
  }
  ...
  if (type === 'cardform') {
    return (
      <div>
        <h3 className="dumip-FormTitle">{header}</h3>
        {FormDom}
        <Divider type="horizontal" className="dumip-FormDivider" />
      </div>
    );
  }
  return (
